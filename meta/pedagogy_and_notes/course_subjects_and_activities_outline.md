...
- **Speculative Device Miro Vignette Exercise**: Generating 3-layer prompt narratives (_The World, The Human Tension, The Object Ritual_) and mapping device state flows in Miro.
...
| :----------------- | :-------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------- |
| **Project 1**      | **The "Unuseless" Interactive Device** _(Chindōgu)_ | Physical computing basics, Pico/CircuitPython, sensors, cardboard chassis, and playful absurdist theory.                           | Functional prototype + 2D/3D physical housing + code repository.                  |
