# Device Art Course Tasks

## High Priority: Week 1 Post-Class & Week 2 Setup
- [ ] Email/talk to Parsons Making Center / AMT admin regarding studio materials and lab supplies for class +device-art #admin #ariel @email
- [ ] Send out Canvas Announcement / Email about the $44.50 hardware kit bundle, payment methods, and self-sourcing options +device-art #supplies #canvas #ariel @computer
- [ ] Publish Homework 01 (Software setup + 3 Idea Board Friction Concepts) to Canvas Assignments +device-art #homework #canvas #ariel @computer
- [ ] Sync finalized syllabus (`canvas/syllabus/syllabus_fall2026.md`) to the Canvas Syllabus tab +device-art #syllabus #canvas #ariel @computer
- [ ] Check Canvas roster for Maren McHugh and Isabella Pan registration processing +device-art #roster #ariel @computer
